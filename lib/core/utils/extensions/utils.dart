...
extension UtilsExtension on String {
  ...
  bool get hasCapitalLetter => _Utils.hasCapitalLetter(this);

  bool get isBool => _Utils.isBool(this);

  bool get isVideo => _Utils.isVideo(this);

  bool get isImage => _Utils.isImage(this);

  bool get isAudio => _Utils.isAudio(this);

  bool get isPPT => _Utils.isPPT(this);

  bool get isWord => _Utils.isWord(this);

  bool get isExcel => _Utils.isExcel(this);

  bool get isAPK => _Utils.isAPK(this);

  bool get isPDF => _Utils.isPDF(this);

  bool get isTxt => _Utils.isTxt(this);

  bool get isChm => _Utils.isChm(this);

  bool get isVector => _Utils.isVector(this);

  bool get isHTML => _Utils.isHTML(this);

  bool get isUsername => _Utils.isUsername(this);
  ...
  bool get isSSN => _Utils.isSSN(this);
  ...
  bool get isPalindrome => _Utils.isPalindrome(this);
  ...
  bool isLengthGreaterThan(int maxLength) =>
      _Utils.isLengthGreaterThan(this, maxLength);

  bool isLengthGreaterOrEqual(int maxLength) =>
      _Utils.isLengthGreaterOrEqual(this, maxLength);

  bool isLengthLessThan(int maxLength) =>
      _Utils.isLengthLessThan(this, maxLength);

  bool isLengthLessOrEqual(int maxLength) =>
      _Utils.isLengthLessOrEqual(this, maxLength);

  bool isLengthEqualTo(int otherLength) =>
      _Utils.isLengthEqualTo(this, otherLength);

  bool isLengthBetween(int minLength, int maxLength) =>
      _Utils.isLengthBetween(this, minLength, maxLength);

  bool get isCaseInsensitiveContainsAny =>
      _Utils.isCaseInsensitiveContainsAny(this, this);

  bool isLowerThan(num b) => _Utils.isLowerThan(double.parse(this), b);

  bool isGreaterThan(num b) => _Utils.isGreaterThan(double.parse(this), b);

  bool isEqual(num b) => _Utils.isEqual(double.parse(this), b);
  ...
  String? snakeCase({String separator = '_'}) =>
      _Utils.snakeCase(this, separator: separator);

  String? get paramCase => _Utils.paramCase(this);

  String get numericOnly => _Utils.numericOnly(this);

  String get capitalizeAllWordsFirstLetter =>
      _Utils.capitalizeAllWordsFirstLetter(this);
}

extension UtilsListExtension<T> on List<T> {
  bool get isOneAKind => _Utils.isOneAKind(this);
}

extension UtilsDynamicExtension on dynamic {
  bool get isOneAKind => _Utils.isOneAKind(this);

  bool get isNull => _Utils.isNull(this);
}
